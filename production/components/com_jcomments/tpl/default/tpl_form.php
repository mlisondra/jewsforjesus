...
<p>
	<span>
		<input id="comments-form-name" type="text" name="name" value="Name" maxlength="<?php echo $this->getVar('comment-name-maxlength');?>" size="22" tabindex="1" />
...
<p>
	<span>
		<input id="comments-form-email" type="text" name="email" value="E-mail" size="22" tabindex="2" />
