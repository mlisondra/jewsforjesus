...
<td><p>The next step is to make a deposit of ${total_reg_fee}. You can do this by:</p>
	<ul>
		<li>
			<a href="<?php print $base_url; ?>registration-payment?event=campgilgal&ref=<?php echo $form->data['chronoform_data']['cf_uid'];?>"><strong>Click here to pay online</strong></a></p>
