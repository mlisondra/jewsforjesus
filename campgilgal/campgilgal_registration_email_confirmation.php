...
<tr>
<td align="left"><strong>Fisrt Name</strong></td>
<td>&nbsp;&nbsp;&nbsp;</td>
...
<table width="100%">
<tr>
<td bgcolor="#79BAEC" colspan="7">&nbsp;&nbsp;<strong>CHILDREN INFORMATION</strong></td>
</tr>
<tr>
<td colspan="7"><p><strong>Note: </strong>To complete your  registration, <strong>please include a deposit $50 per camper for summer camp</strong> and <strong>$25  per camper for winter camp</strong>, unless other arrangements have been made. Your  deposit will be credited as a partial payment of your camp fees.</p>
</td>
</tr>
<tr>
...
<!-- Comments - End -->
<tr>
<td bgcolor="#79BAEC">&nbsp;&nbsp;<strong>PAYMENT OPTION</strong></td>
</tr>
<tr>
<td><p>The next step is to make a deposit of ${total_reg_fee}. You can do this by:</p>
<ul>
    <li>
        <strong><a href="https://store.jewsforjesus.org/donateonline/designate/?amount={total_reg_fee}&other=camp gilgal registration" target="_blank">Paying online.</a></strong>
        <p>By clicking  this link you will be directed to the donation  section of the Jews for Jesus website. You can make  a payment for Camp Gilgal or donate to this ministry there. Most information  will already be filled out for you. What we need from you is:</p>
        <ul>
          <li>the amount of your payment.</li>
          <li>the name of your camper(s) and the camp(s) they&rsquo;re attending. Enter this  information in the comment box at the bottom of the screen. </li>
          <li>your  credit card information. <br>
          <strong><a href="https://store.jewsforjesus.org/donateonline/designate/?amount={total_reg_fee}&other=camp gilgal registration" target="_blank">Pay online here</a></strong>          </li>
        </ul>
        <br>
        <p>You can also include a donation along with your payment by  clicking the blue Add Another Gift button. Simply select Project, choose Camp  Gilgal from the drop down menu, and enter the amount you would like to give.  All gifts to Camp Gilgal are tax-deductible.</p>
    </li>
    <li>
      <p><strong>Writing  a check. </strong><strong>Make it payable to Jews  for Jesus</strong> and in the memo section write, &rdquo;Camp Gilgal payment.&rdquo; Mail it to: Jews  for Jesus, 60 Haight Street, San Francisco, CA 94102-5895. </p>
    </li>
    <li><p><strong>Call LouAnn Gonzalez</strong> at (415) 864-2600 at extension 119 to make a credit card payment by phone.</p></li>
</ul>
<p>Any questions? Call <strong>Cricket – Kathy Nichols</strong> at (415)  864-2600, ext. 1153.</p>
